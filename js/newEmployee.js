...
function validar() {
  ...
  if (telefone == "") {
    document.getElementById("textAlertas").innerHTML +=
      "<div>Campo Telefone está vazio!</div>";
    document.getElementById("alertas").style.display = "flex";
  ...
  if (email == "") {
    document.getElementById("textAlertas").innerHTML +=
      "<div>Campo Email está vazio!</div> ";
    document.getElementById("alertas").style.display = "flex";
  ...
  if (numeroIdentidade == "") {
    document.getElementById("textAlertas").innerHTML +=
      "<div>Campo Numero da Identidade está vazio!</div> ";
    document.getElementById("alertas").style.display = "flex";
